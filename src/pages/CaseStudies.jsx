    ...
    <div className="page-cases">
      <section className="page-hero brand-field on-brand">
        <div className="wrap">
          ...
          <p className="lead rv in rv-d1">wybrane realizacje. sekcja rośnie z każdym kwartałem — najlepsze historie dopiero się dzieją.</p>
        </div>
      </section>
        ...
        <div className="wrap">
          {items === null ? (
            ...
            <div className="post-grid" style={{ gridTemplateColumns: 'repeat(2, 1fr)' }}>
              {items.map((c, i) => (
                <div key={c.slug} className={'card post-card rv rv-d' + (i % 2)}>
